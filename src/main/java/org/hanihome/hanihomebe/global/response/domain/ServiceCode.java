...
public enum ServiceCode {
    ...
    ACCESS_REFRESH_TOKEN_EXPIRED(HttpStatus.BAD_REQUEST, "액세스 토큰과 리프레시 토큰 모두 만료되었습니다"),
    ...
    TEMPORARY_PROPERTY_NOT_BELONGS_TO_YOU(HttpStatus.BAD_REQUEST, "본인의 임시저장 매물이 아닙니다."),
