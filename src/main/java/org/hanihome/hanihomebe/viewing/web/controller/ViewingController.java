...
public class ViewingController {
    ...
    @GetMapping("/viewings/my-viewings/dates")
    ...
    // cancel
    @PutMapping("/viewings/{viewingId}/cancel")
    ...
    // 매물 노트 업로드
    @PutMapping("/viewings/{viewingId}/property-notes")
    ...
    // 체크리스트 - 아이템 선택
    @PutMapping("/viewings/checklists")
    ...
    // 체크리스트 - 선택된 아이템 조회
    @GetMapping("/viewings/{viewingId}/checklists")
